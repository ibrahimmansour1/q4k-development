...
class SectionOtherFilesScreen extends StatefulWidget {
  const SectionOtherFilesScreen({super.key, required this.subjectFileName});

  final String subjectFileName;

  @override
  State<SectionOtherFilesScreen> createState() =>
      _SectionOtherFilesScreenState();
}

class _SectionOtherFilesScreenState extends State<SectionOtherFilesScreen> {
  ...
  void initState() {
    super.initState();
    download = FirebaseApi.listAll(
        '/material/${widget.subjectFileName}/section/others');

    futureFiles = FirebaseStorage.instance
        .ref('/material/${widget.subjectFileName}/section/others')
        .listAll();
  }
